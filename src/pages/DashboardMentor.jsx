  ...
  return (
    <div className="p-5">
      <div className="flex justify-between items-center mb-5">
        <div>
          <h1 className="text-3xl font-bold text-gray-800">Dashboard Mentor</h1>
      ...
      <div className="bg-gray-50 p-5 rounded-xl mt-5">
        <h2 className="text-xl font-semibold mb-4 text-gray-800">
          Fitur Mentor (Coming Soon)
        </h2>
        <ul className="space-y-2 text-gray-700">
          <li className="flex items-start">
            <span className="text-[#667eea] mr-2">•</span>
            <span>Membuat dan mengelola task</span>
          </li>
          <li className="flex items-start">
            <span className="text-[#667eea] mr-2">•</span>
            <span>Membuat dan mengelola tim</span>
          </li>
          <li className="flex items-start">
            <span className="text-[#667eea] mr-2">•</span>
            <span>Approve task dari mentee</span>
          </li>
          <li className="flex items-start">
            <span className="text-[#667eea] mr-2">•</span>
